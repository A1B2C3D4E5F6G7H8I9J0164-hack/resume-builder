(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/_3daffa31._.js", {
...
__turbopack_context__.s({
    ...
    "createCookiesWithMutableAccessCheck": (()=>createCookiesWithMutableAccessCheck),
 ...
 */ __turbopack_context__.s({
    "createDefaultCacheHandler": (()=>createDefaultCacheHandler)
});
...
{
__turbopack_context__.s({
    "createPromiseWithResolvers": (()=>createPromiseWithResolvers)
});
...
const handler = (("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : mod.middleware) || mod.default;
...
if (typeof handler !== 'function') {
    throw new ProxyMissingExportError(`The ${("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : 'Middleware'} file "${page}" must export a function named \`${("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : 'middleware'}\` or a default function.`);
}
        ...
        try {
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$is$2d$next$2d$router$2d$error$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["isNextRouterError"])(err)) {
                    err.message = `Next.js navigation API is not allowed to be used in ${("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : 'Middleware'}.`;
                    throw err;
                }
            }
            const req = args[0];
...
//# sourceMappingURL=_3daffa31._.js.map